...
public class AddressBottomSheet extends BottomSheetDialogFragment{
    public AddressBottomSheet(com.example.farmerapp.Data.Address address){
    ...
    public com.example.farmerapp.Data.Address address;
    ...
    public interface OnConfirmLocationListener {
        void onConfirmLocation(com.example.farmerapp.Data.Address address);
    }
