...
public class RegisterDetailsFragment extends Fragment {
    ...
    public void addButtonClickListeners(){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RegisterDetailsActivity.viewModel.farmer.setName(name.getText().toString());
                RegisterDetailsActivity.viewModel.farmer.setAlternateMob(alternatePhone.getText().toString());
